...
function updateMemberForm(member) {
	...
	<div id="form-content">
        ...
        <input type="text" name="firstName" id="firstName" minlength="2" maxlength="20" value="${member.firstName}" required>
        
        <label for="lastName">Last name</label>
        <input type="text" name="lastName" id="lastName" minlength="2" maxlength="20" value="${member.lastName}" required>
